...
2. **Source composition** (e.g., based on eDNA metabarcoding, particle-tracking simulations, or other community-composition data).
...
2. **Unsampled-source tracer signatures**:
   ...
   - Estimated jointly across tracers using a covariance-informed prior derived from the sampled-source tracer signatures.
...
#> 1        Macroalgae 0.90    0.86     0.94
#> 2          Mangrove 0.95    0.93     0.97
#> 3         Saltmarsh 0.31    0.15     0.48
#> 4          Seagrass 0.87    0.83     0.92
#> 5              SPOM 0.98    0.98     0.99
#> 6 Terrestrial grass 0.88    0.84     0.92
#> 7         Unsampled 0.87    0.84     0.90
```
...
* Barneche, D. R. *et al.* MixMustR: a data-integrative Bayesian approach to tracer-based ecological mixing problems with an unsampled-source component. Manuscript describing the statistical models in full detail. [https://github.com/open-AIMS/mixmustr_paper](https://github.com/open-AIMS/mixmustr_paper)
